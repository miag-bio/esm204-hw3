...
The marginal cost per kwH of electricity is $0.018
...
l_pred <- tibble(price = price,
                 demand = model_demand_l$coefficient[1]*price)

#plot
ggplot() +
  geom_line(agg_data, mapping = aes(x = Qagg, y = price), lty = "dotdash") +
  geom_line(l_pred, mapping = aes(x = demand, y = price), lty = "dotted")
